...
import { Collapse, Link, Paper } from "@material-ui/core";
...
export default function Profile(): JSX.Element {
	...
	return (
		<Paper className={classes.sidebarProfile}>
			{/* <React.Fragment> */}
			<Button onClick={toggleDrawer("right", true)} style={{ background: "transparent" }}>
